...
class PixelMapDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # odd channels: time
        pm_view1 = hdf5_file['data'][idx][[0,1]]
        pm_view2 = hdf5_file['data'][idx][[2,3]]
        if self.channel == 'time':
            pm_view1 = hdf5_file['data'][idx][[1]]
            pm_view2 = hdf5_file['data'][idx][[3]]
        if self.channel == 'charge':
            pm_view1 = hdf5_file['data'][idx][[0]]
            pm_view2 = hdf5_file['data'][idx][[2]]
        ...
        return pm_view1, pm_view2, label